"""
population_neat_gru_test.py

Test the basic functionality of a NEAT-GRU population (i.e. all genomes contain GRU hidden nodes).
...
def get_population():
    ...
    cfg.genome.rnn_prob_gru = 1  # Always mutate a GRU-node
    ...
    # Mutate population such that at least one genome has a GRU-node
    pop.population[1].mutate_add_node(cfg.genome)  # Population starts count at 1
    
    return pop


class PopulationNeatGruTest(unittest.TestCase):
