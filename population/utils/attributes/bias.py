...
def init(cfg: GenomeConfig):
    ...
    return clip(gauss(cfg.bias_init_mean, cfg.bias_init_stdev), a_min=cfg.bias_min_value, a_max=cfg.bias_max_value)
...
def mutate(v, cfg: GenomeConfig):
    ...
    elif r < cfg.bias_replace_rate + cfg.bias_mutate_rate:
        return init(cfg)
