...
Gene-representation of a hidden GRU node.
"""
import sys
...
if 'linux' in sys.platform:
    from population.utils.rnn_cell_util.cy.berkeley_gru_cy import GRUCellCy as GRU
else:
    from population.utils.rnn_cell_util.berkeley_gru import GRUCell as GRU


class GruNodeGene(RnnNodeGene):
