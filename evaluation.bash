...
max_v=9;  # Maximum version for evaluation
...
#  python3 evaluate_populations.py --evaluate_gen=$evaluate_gen --evaluate_pop=$evaluate_pop --experiment=$experiment --folder_pop=NEAT-LSTM --max_v=$max_v;
